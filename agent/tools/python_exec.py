...
SAFE_BUILTIN_NAMES = {
    ...
    "len", "list", "map", "max", "min", "pow", "print", "range", "reversed",
...
SPEC = {
    "name": "python_exec",
    "description": "Run a short Python snippet for arithmetic / list / string operations. Use print() to return values. No imports, no file I/O, no network. 5s timeout.",
}
